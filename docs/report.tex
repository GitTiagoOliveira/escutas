...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\textwidth]{img/view-recover.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.34\textwidth]{img/view-news-feed-1.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.34\textwidth]{img/view-news-feed-2.png}
